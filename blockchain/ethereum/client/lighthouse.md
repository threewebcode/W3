...
The beacon node is a big data object which stores block, attestation and process them at the same time. The state, reward as well as slashing are processed on the basis of block and state.
